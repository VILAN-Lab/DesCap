...
from model6.densecap import densecap_resnet50_fpn
...
USE_TB = True
USE_TB2 = False
CONFIG_PATH = '/media/ubuntu/disk1/hyj/denC/model_params'

### v1.2 ###
MODEL_NAME = 'v1.2_gcn_trans_cat_region_weight055_woira_detr2'
IMG_DIR_ROOT = '/media/ubuntu/disk1/hyj/denC/DenseCaption/Untitled_Folder'
VG_DATA_PATH = '/media/ubuntu/disk1/hyj/denC/DenseCaption/Untitled_Folder/VG-regions-lite.h5'
LOOK_UP_TABLES_PATH = '/media/ubuntu/disk1/hyj/denC/DenseCaption/Untitled_Folder/VG-regions-dicts-lite.pkl'
...
# ## v1.0 ###
# MODEL_NAME = 'v1.0_gcn_trans_cat_region_weight055'
# IMG_DIR_ROOT = '/home/ubuntu/D/hyj/data/visual-genome-v1.2'
...
def set_args():
    ...
    # Training Settings
    args['detect_loss_weight'] = 0.55  # 1.
...
def train(args):
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        for batch, (img, targets, info) in enumerate(train_loader):  # item 1 image, batch_size = 1
            ...
            if iter_counter >= 20000 and iter_counter % 20000 == 0:
                try:
    ...
    save_model2(model, optimizer, results, iter_counter, flag='end')
