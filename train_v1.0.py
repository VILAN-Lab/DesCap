...
MODEL_NAME = 'v1.0_dr_transformer_bz_1_epoch_8'
IMG_DIR_ROOT = '/home/ubuntu/D/hyj/data/visual-genome-v1.2'
VG_DATA_PATH = './data/data_new/VG-regions-lite-v1.0-new.h5'
LOOK_UP_TABLES_PATH = './data/data_new/VG-regions-dicts-lite-v1.0-new.pkl'
