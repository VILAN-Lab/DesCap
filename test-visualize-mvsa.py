...
from model2.densecap import densecap_resnet50_fpn

from dataset_mvsa import DenseCapDataset, DataLoaderPFG
...
def save_results_to_file(img_list, all_results, console_args):
    ...
    with open(os.path.join(console_args.result_dir, 'mvsa_17024_densecap.json'), 'w') as f:
        json.dump(results_dict, f, indent=2)

    if console_args.verbose:
        print('[INFO] result save to {}'.format(os.path.join(console_args.result_dir, 'mvsa_17024_densecap.json')))
        if console_args.extract:
...
def main(console_args):
    ...
    IMG_DIR_ROOT = '/home/ubuntu/D/hyj/data/mvsa/MVSA_multiple/data'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_json', type=str,default='/home/ubuntu/D/hyj/project/densecap2/model_params/v1.2_gcn_trans_cat_region_weight055/config.json', help="path of the json file which stored model configuration")
    parser.add_argument('--lut_path', type=str, default='/home/ubuntu/D/hyj/project/densecap-pytorch-main/data/data_new/VG-regions-dicts-lite.pkl', help='look up table path')
    parser.add_argument('--model_checkpoint', type=str, default='/home/ubuntu/D/hyj/project/densecap2/model_params/v1.2_gcn_trans_cat_region_weight055/v1.2_gcn_trans_cat_region_weight055_iter:520000_best_map_11.80182.pth.tar', help="path of the trained model checkpoint")
    parser.add_argument('--img_path', type=str, default='/home/ubuntu/D/hyj/data/mvsa/MVSA_multiple/data',help="path of images, should be a file or a directory with only images")
    ...
    RESULT_JSON_PATH = './test-result/mvsa_17024_densecap.json'
    with open(RESULT_JSON_PATH, 'r') as f:
        results = json.load(f)
    ...
    for i in range(0,5):
        ...
        #IMG_FILE_PATH = '/home/ubuntu/D/hyj/data/visual-genome-v1.2/VG_100K/2359438.jpg'
        
        print(new_path2)
        start, TO_K = 0,6

        visualize_result(new_path2, results[IMG_FILE_PATH][start:TO_K])
    a = 1
