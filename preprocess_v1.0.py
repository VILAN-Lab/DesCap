...
if __name__ == '__main__':
    ...
    parser.add_argument('--region_data',
                        default='/home/ubuntu/D/hyj/data/visual-genome-v1.2/region_descriptions_v1.0.json',
    ...
    parser.add_argument('--pickle_output',
                        default='data/data_new/VG-regions-dicts-lite-v1.0-new.pkl',
                        help='Path to output pickle file')
    parser.add_argument('--h5_output',
                        default='data/data_new/VG-regions-lite-v1.0-new.h5',
